    ...
    static class IntersectedFeatureCollection extends DecoratingSimpleFeatureCollection {
        ...
        public IntersectedFeatureCollection(SimpleFeatureCollection delegate,
            ...
            this.fb = new SimpleFeatureBuilder(tb.buildFeatureType());
                ...
                //builder.setName(descriptor.getName().toString());
                ...
                AttributeDescriptor intersectionDescriptor = builder.buildDescriptor(name,descriptor.getType());
                //AttributeDescriptor intersectionDescriptor = builder.buildDescriptor(descriptor.getName(),descriptor.getType());
