...
public class HtmlButton extends JLabel {
     ...
     * 
     */
    private static final long serialVersionUID = -685397698745604309L;

    static protected Color light = new Color(220, 220, 220);
    ...
    public static class HtmlRadioButton extends HtmlButton {
         ...
         * 
         */
        private static final long serialVersionUID = 2255644555050530355L;
